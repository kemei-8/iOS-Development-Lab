...
//Because distanceTraveled can be inferred as an int and a double (more than one type), a specification of the type as a Double would allow the variable to support more specific values.

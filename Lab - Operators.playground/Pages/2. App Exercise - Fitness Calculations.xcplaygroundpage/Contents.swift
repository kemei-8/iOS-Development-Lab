...
//This result, using Double as the data type, yields a result that is also a Double. It is also more precise than the previous answer, which infers the data type to be an interger.
/*:
...
print("You have reached", percentOfGoal, "percent of your goal.")

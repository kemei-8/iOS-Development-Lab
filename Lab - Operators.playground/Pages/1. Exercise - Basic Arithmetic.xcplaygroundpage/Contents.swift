...
print("This value is more exact because the data type has been declared as a Double instead of inferred to be an interger. ")
...
//Create a function using Booleans. If integer is even, the remainder will be 0. If interger is odd, the remainder will be 1. 

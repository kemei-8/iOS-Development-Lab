...
func pacing(currentDistance:Double, totalDistance:Double, currentTime:Double, goalTime:Double){
    if (totalDistance - currentDistance)/(currentDistance / currentTime) > goalTime{
        print("Keep it up!")}
    else if (totalDistance - currentDistance)/(currentDistance / currentTime) < goalTime{
        print("You've got to push it just a bit harder!")
    }
}

pacing(currentDistance:10.0, totalDistance:20.0, currentTime:20.0, goalTime:30.0)
